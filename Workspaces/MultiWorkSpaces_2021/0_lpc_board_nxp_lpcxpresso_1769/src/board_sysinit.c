...
void Board_SetupClocking(uint32_t XTAL_FREQ)
{
	Chip_SetupXtalClocking(128000000, XTAL_FREQ);
...
void Board_SystemInit(uint32_t XTAL_FREQ)
{
	Board_SetupMuxing();
	Board_SetupClocking(XTAL_FREQ);
}

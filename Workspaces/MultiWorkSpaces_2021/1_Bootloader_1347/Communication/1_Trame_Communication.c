...
void _1_Communication_Init(void)
{
	...
	xTaskCreate(_1_Communication_Recomposition_Rx, (char *) "1_Com_Recompo_Rx", 180, NULL, (tskIDLE_PRIORITY + 2UL), (xTaskHandle *) NULL);
}
...
__attribute__((optimize("O0"))) BaseType_t _1_Communication_Create_Trame_From_Buffer(RINGBUFF_T *buff)
{
	RINGBUFF_T* RingBuff = buff;

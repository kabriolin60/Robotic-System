...
void _0_RS485_Init(uint8_t RS485_dir_port, uint8_t RS485_dir_bit)
{
	...
	Chip_GPIO_WriteDirBit(LPC_GPIO_PORT, RS485_dir_port, RS485_dir_bit, true);	//dir pin en sortie
...
{
	Chip_GPIO_WritePortBit(LPC_GPIO_PORT, RS485_dir_port, RS485_dir_bit, true);
}
...
{
	Chip_GPIO_WritePortBit(LPC_GPIO_PORT, RS485_dir_port, RS485_dir_bit, false);
}

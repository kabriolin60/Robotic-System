 ...
 **
 *****************************************************************************/
void _0_RS485_Master_Mode(uint8_t port, uint8_t bit)
{
	Chip_GPIO_WritePortBit(LPC_GPIO, port, bit, true);
}
 ...
 **
 *****************************************************************************/
void _0_RS485_Slave_Mode(uint8_t port, uint8_t bit)
{
	Chip_GPIO_WritePortBit(LPC_GPIO, port, bit, false);
}

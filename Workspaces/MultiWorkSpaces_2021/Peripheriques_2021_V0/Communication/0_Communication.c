...
void _0_Communication_Init(void)
{
	...
	_1_xQueue_Message_TO_Send = xQueueCreate( 3, sizeof( struct Communication_Message ));
...
{
	Chip_IOCON_PinMuxSet(LPC_IOCON, IOCON_PIO1_6, (IOCON_FUNC1 | IOCON_MODE_INACT));/* 1.6 RXD */
	Chip_IOCON_PinMuxSet(LPC_IOCON, IOCON_PIO1_7, (IOCON_FUNC1 | IOCON_MODE_INACT));/* 1.7TXD */

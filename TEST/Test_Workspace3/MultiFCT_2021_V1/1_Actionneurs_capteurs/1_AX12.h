...
void _1_AX12_MOVE_WITH_TIME(uint8_t ID, unsigned short desti, unsigned short torque, unsigned short time);



void _1_AX12_WAIT_FOR_ACK(struct st_AX_12_Trame *trame, uint8_t wait);

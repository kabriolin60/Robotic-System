...
#define TRC_HWTC_COUNT HWTC_COUNT
#define TRC_IRQ_PRIORITY_ORDER IRQ_PRIORITY_ORDER
#define TRC_HWTC_DIVISOR HWTC_DIVISOR
#define TRC_HWTC_FREQ_HZ configTICK_RATE_HZ * 12800

#define TRC_HWTC_PERIOD HWTC_PERIOD

#define TRC_DWT_CTRL_NOCYCCNT DWT_CTRL_NOCYCCNT_Msk
#define TRC_REG_DWT_CTRL DWT_CTRL_REG
#define TRC_DWT_CTRL_CYCCNTENA DWT_CTRL_CYCCNTENA_Msk

#define TRC_REG_DWT_CYCCNT DWT_CYCLE_COUNTER

#define TRC_DEMCR_TRCENA 1
#define TRC_REG_DEMCR TRC_REG_DWT_CTRL

#define TRC_HWTC_TYPE TRC_FREE_RUNNING_32BIT_INCR//TRC_OS_TIMER_INCR

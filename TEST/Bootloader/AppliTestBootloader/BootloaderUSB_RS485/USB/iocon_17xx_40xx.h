 ...
 * @return	Nothing
 */
inline void Chip_IOCON_Init(LPC_IOCON_T *pIOCON);
 ...
 * @return	Nothing
 */
inline void Chip_IOCON_EnableOD(LPC_IOCON_T *pIOCON, uint8_t port, uint8_t pin);
 ...
 * @return	Nothing
 */
inline void Chip_IOCON_DisableOD(LPC_IOCON_T *pIOCON, uint8_t port, uint8_t pin);
 ...
 * @return	Nothing
 */
inline void Chip_IOCON_SetI2CPad(LPC_IOCON_T *pIOCON, IOCON_I2CPINS_CONFIG cfg);
 ...
 * @return	Nothing
 */
inline void Chip_IOCON_PinMuxSet(LPC_IOCON_T *pIOCON, uint8_t port, uint8_t pin, uint32_t modefunc)
{
 ...
 * @return	Nothing
 */
inline void Chip_IOCON_PinMux(LPC_IOCON_T *pIOCON, uint8_t port, uint8_t pin, uint32_t mode, uint8_t func)
{

(Music)
･Be Up In Arms (Loop) / (c) Fantom (Composed/Arranged/Edited the Loop)

(Sound Effect)
･Ping Pong x2 / (c) Fantom (Create with synthesizer)
･Boo-Boo / (c) Fantom (Create with synthesizer)

(*) You can use Music & Sound Effects as a material for game or other application.
